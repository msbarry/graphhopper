...
public class DouglasPeuckerTest {
    ...
    public void test3dPathSimplifyElevationDisabled() {
        ...
        pointList.add(0.04, 0, 50);
        new DouglasPeucker().setMaxDistance(1).setElevationMaxDistance(0).simplify(pointList);
        assertEquals("(0.0,0.0,0.0), (0.04,0.0,50.0)", pointList.toString());
    }

    @Test
    public void test3dPathSimplifyElevationMaxDist5() {
        PointList pointList = new PointList(5, true);
        pointList.add(0, 0, 0);
    ...
    @Test
    public void testSimplifyExcludeFirstLast() {
        PointList pointList = new PointList(5, false);
        pointList.add(0, 0);
        pointList.add(0, 1);
        pointList.add(1, 1);
        new DouglasPeucker().setMaxDistance(1).setElevationMaxDistance(1).simplifyExcludeFirstLast(pointList);
        assertEquals("(0.0,1.0)", pointList.toString());
    }
}
